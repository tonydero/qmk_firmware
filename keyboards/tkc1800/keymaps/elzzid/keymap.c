...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [BASE] = LAYOUT(
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,                    KC_PSCR, KC_HOME, KC_PGUP, KC_VOLU, \
                                                                                                                                           KC_INS,  KC_END,  KC_PGDN, KC_VOLD, \
   ...
   */
  [FUNCTION] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   KC_SLCK, _______, _______, _______, \
                                                                                                                                           KC_PAUS, _______, _______, _______, \
