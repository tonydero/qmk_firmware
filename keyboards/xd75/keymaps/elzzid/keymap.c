...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QW] = { /* QWERTY */
  { KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0    },
  { KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    UC_MOD,  XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P    },
  { KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_GESC, XXXXXXX, XXXXXXX, XXXXXXX, KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN },
  { KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_TAB,  XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH },
  { XXXXXXX, RGB_TOG, KC_LALT, MO(_LO), KC_LSFT, KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, KC_SPC,  MO(_RA), TO(_FN), KC_QUOT, KC_BSLS },
 ...
 [_LO] = { /* LOWER */
  ...
  { XXXXXXX, RGB_MOD, KC_RALT, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX  },
 },
 ...
 [_RA] = { /* RAISE */
  ...
  { XXXXXXX, RGB_M_K, KC_RALT, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX  },
 },

 [_FN] = { /* FUNCTION */
  { XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NLCK, KC_PSLS, KC_PAST, XXXXXXX  },
